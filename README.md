...
[Neon Motorworks model loading and environment mapping](esp32-neon-car/README.md).
Each showcase is reviewed on hardware before the next is started.

Painter sorting is the default for the template cube, textured crate, island and neon car.
