...
// Procedural exhibition: painter rendering, selective precise sorting.
#define Z_BUFFERING 0
#define SORT_TRIANGLES 0 // Scene-wide precise sorting preserves immutable topology.
// Keep useful painter precision across the exhibition's camera ranges.
...
#define BILINEAR_FILTER 0 // Nearest studio reflections on hardware.
#define LIGHTING 1
