...
// The 822-vertex transform scratch fits in internal RAM; fallback is automatic.
...
#define POSTFX_CELLSHADING 1 // Cell shading effect
...
#define CELLSHADING_CELL_BITS 6      // Reduce precision of lighting to create a cell shading effect (0-8)
