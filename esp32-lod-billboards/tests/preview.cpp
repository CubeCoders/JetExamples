...
int main(){
 ...
 int high=check(1799),low=check(1801),transition=check(2500),far=check(2601);assert(high>low+400);assert(transition>far+100);std::printf("Boundary tris: %d -> %d -> %d -> %d\n",high,low,transition,far);
