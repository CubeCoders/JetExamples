...
#define JET_MESH_INSTANCING 1 // Compile shared immutable geometry support.
...
// The rotors do not intersect; precise painter sorting needs no depth buffer.
#define Z_BUFFERING 0
#define SORT_TRIANGLES 0 // Scene-wide precise sorting preserves immutable topology.
// Keep useful painter precision across the rotors' camera range.
...
#define BILINEAR_FILTER 0 // This comparison uses solid colours.
#define LIGHTING 1
...
#define CELLSHADING_CELL_BITS                                                                      \
    4 // Reduce precision of lighting to create a cell shading effect (0-8)
